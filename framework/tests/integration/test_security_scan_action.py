...
class TestSecurityScanAction:
    ...
    def action_yml_path(self):
        ...
        return Path(__file__).parent.parent.parent.parent / "actions" / "security-scan" / "action.yml"
    ...
    def test_action_yml_structure(self, action_config):
        ...
        # Verify key outputs
        required_outputs = [
            "success", "security-level", "execution-time",
            "vulnerabilities-found", "tools-executed"
        ]
    ...
    def test_tool_enable_inputs(self, action_config):
        ...
        tool_inputs = [
            "enable-bandit", "enable-safety", "enable-pip-audit",
...
"""
    ...
    def test_bandit_integration(self, mock_run, temp_project):
        ...
        cmd = [
            "bandit", "-r", str(temp_project),
            "-f", "json",
            "-o", str(reports_dir / "bandit-results.json"),
    ...
    def test_safety_integration(self, mock_run, temp_project):
        ...
        cmd = ["safety", "check", "--json", "--output", str(reports_dir / "safety-results.json")]
    ...
    def test_pip_audit_integration(self, mock_run, temp_project):
        ...
        cmd = ["pip-audit", "--format=json", "--output", str(reports_dir / "pip-audit-results.json")]
