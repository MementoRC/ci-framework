...
class TestQualityGatesBDD:
    ...
    @pytest.mark.parametrize("package_manager,expected_command", [
        ("pixi", "pixi run -e quality"),
        ("hatch", "hatch run quality:test"),
        ("poetry", "poetry run pytest"),
        ("pip", "python -m pytest"),
    ])
    def test_package_manager_detection(self, package_manager: str, expected_command: str):
        """
    ...
    @pytest.mark.parametrize("project_path,expected_patterns", [
    ...
    def test_integration_project_compatibility(self, project_path: str, expected_patterns: List[str]):
        """
